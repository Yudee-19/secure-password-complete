...
const Navbar = () => {
    return (
        <nav className="w-screen h-[82px] sticky top-0 bg-customDark-0 shadow-[0px_-8px_0px_0px_rgba(0,0,0,0.1)] z-50 ">
            <div className="flex items-center justify-between h-full px-[50px]">
                ...
                {/* Search Input Box */}
                <div className="w-[681px] h-[50px] bg-customDark-200 rounded-md border-[2px] border-[#555555] flex items-center ">

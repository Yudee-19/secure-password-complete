...
interface AddBankAccountSidebarProp {
    isOpen: boolean;
    onClose: () => void;
}
...
const AddBankAccountSidebar: React.FC<AddBankAccountSidebarProp> = ({
    isOpen,
    onClose,
}) => {
                        ...
                        <div className="flex flex-col gap-4 items-center">
                            {formFields.map((field) =>
                                field.height === "100px" ? (
                                    ...
                                    >
                                        <textarea className="w-full h-full outline-none bg-transparent rounded border-2 border-[#5a5a5a] text-[#a0a0a0] pl-6 pt-6" />
...
export default AddBankAccountSidebar;

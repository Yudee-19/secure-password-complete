    ...
    return (
        <div className="w-full min-h-screen 2xl:pl-[335px] pl-[270px]  pt-[82px] bg-customDark-50 flex flex-col  ">
            ...
            <div className="grid grid-cols-12 px-9 pt-[27px] divide-y-10 ">
                ...
                {/* Individual items */}
                <div className=" relative grid grid-cols-12 col-span-12 border-b-2 h-[72px] border-[#5a5a5a] hover:bg-hoverdark-2 group">
                    <span className=" flex justify-between items-center px-[2px]">
                        <input
                            type="checkbox"
                            className="w-4 h-4 col-start-1 border-[#bebebe] rounded-sm "
                    ...
                    <div className="col-start-12 flex items-center relative">
                        <span
